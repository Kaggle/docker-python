...
RUN python -m spacy download en && python -m spacy download en_core_web_lg

RUN apt-get -y install dbus fontconfig fontconfig-config fonts-dejavu-core fonts-droid ghostscript gsfonts hicolor-icon-theme \
